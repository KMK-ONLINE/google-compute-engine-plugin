        ...
        public FormValidation doCheckBootDiskSourceImageName(@AncestorInPath Jenkins context,
            ...
            try {
                if (value.contains("https://www.googleapis.com")) {
                    ...
                    return FormValidation.error("Please fill like this value: https://www.googleapis.com/compute/v1/projects/YOUR-PROJECT-NAME/global/images/YOUR-JENKINS-IMAGE");
                }
            } catch (ArrayIndexOutOfBoundsException ex){
                return FormValidation.error(ex, "Please fill like this value: https://www.googleapis.com/compute/v1/projects/YOUR-PROJECT-NAME/global/images/YOUR-JENKINS-IMAGE");
            }
            ...
            try {
                ...
                return FormValidation.error(iae, "Please fill like this value: https://www.googleapis.com/compute/v1/projects/YOUR-PROJECT-NAME/global/images/YOUR-JENKINS-IMAGE");
            }
            return FormValidation.ok();
        }
